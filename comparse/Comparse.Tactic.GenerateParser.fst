/// Comparse.Tactic.GenerateParser
/// ==============================
...
val is_parametrized_by_bytes_typeclass: term -> Tac bool
let is_parametrized_by_bytes_typeclass typ =
  let typ_typ = tc (top_env ()) typ in
