...
val bytes_compatible_pre_pub_bytes: i:timestamp -> Lemma (bytes_pre_is_compatible (Att.attacker_knows_at i))
  [SMTPat (bytes_pre_is_compatible (Att.attacker_knows_at i))]
let bytes_compatible_pre_pub_bytes i =
bytes_pre_is_compatible_intro #bytes (Att.attacker_knows_at i)
    (Att.attacker_knows_empty i)
    (fun b1 b2 -> Att.attacker_knows_concat i b1 b2 )
    (fun b sz -> Att.attacker_knows_split i sz b )
    (fun sz n ->  Att.attacker_knows_from_nat i sz n )

instance pub_bytes_bytes_like (i:timestamp):
 Comparse.Bytes.bytes_like (Att.pub_bytes i)
 = Comparse.Bytes.refine_bytes_like bytes (Att.attacker_knows_at i)
